...
Local [MaxMind](https://dev.maxmind.com/geoip/geoip2/geolite2/) database files can be used with the MaxMind [GeoIP2](https://github.com/maxmind/GeoIP2-python) library with the `--service` option:
